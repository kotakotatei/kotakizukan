    ...
    return {
      creature: [
        ...
        },
        {
          ...
          copy: '現代の小さな草食恐竜',
          life: '6～8年',
          comment: `大きくてお部屋で放し飼いしたくなる感じ。
          肉食爬虫類研究家の先生の放し飼いしてる子たちが、窓際でぽかぽか日向ぼっこしてるのを見てからあこがれが…
          でももちろん一般家庭では放し飼いなんてできないし、大きめのケージもいる…（120cmがよいとか）
          エサの頻度と質も高い感じで、ちょっといろいろな覚悟がいりそうだ…！（先生の家では先生より彼らのほうがいいもの食べてるらしい）`
        },
        {
          id: 6,
          category: 'contemporary',
        ...
        },
        {
          ...
          ニシキヘビ独特のフォルム、ピット器官、もっちりとしたからだ、つぶらな瞳…初めて触れたあの日に完全に虜になってしまった…！
        ...
        { 
          ...
          ぬいぐるみは、前職の面接場の机においてあって、一発で名前を言い当てたらくれました。`
         },
        { 
          id: 12,
          category: 'ancient',
          ...
          一番最近では頭だと思われてたのが実はごみで、ほんとうの頭はほっそいのだったみたいでようやく目と口が確認された。
          大きさは3cmくらい。`
         },
      ]
    }
